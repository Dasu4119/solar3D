...
export function mapDesignContext(response: DesignContextApiResponse): DesignContext {
  ...
  return {
    ...
    module: {
      id: module.id!, manufacturer: module.manufacturer ?? "", model: module.model ?? "",
      widthM: Number(module.widthM ?? 0), lengthM: Number(module.lengthM ?? 0),
      powerWatts: Number(module.powerWatts ?? 0), efficiency: Number(module.efficiency ?? 0),
    },
    setback,
  };
}
